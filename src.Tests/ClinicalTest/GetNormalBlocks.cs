...
public class GetNormalBlocks
{
    private readonly ClinicalTest _sut;

    public GetNormalBlocks()
    {
    ...
    public async void GetNormalBlocksTheory(List<Block> expected, params ClinicalTest[] clinicalTests)
    {
    ...
    [Fact]
    public async void GetNormalBlocksNullException()
    {
